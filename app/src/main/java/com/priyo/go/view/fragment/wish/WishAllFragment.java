...
public class WishAllFragment extends Fragment implements HttpResponseListener, RecyclerView.OnItemClickListener {
    ...
    private void fetchAllWishList() {
        getAllWishListTask = new HttpRequestGetAsyncTask(ApiConstants.Command.WISH_LIST_FETCH,
                ApiConstants.Url.SPIDER_API + ApiConstants.Module.UTILITY_MODULE + ApiConstants.EndPoint.WISH_FIND_ENDPOINT, getContext());
