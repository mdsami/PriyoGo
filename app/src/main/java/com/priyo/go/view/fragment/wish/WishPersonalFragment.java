...
public class WishPersonalFragment extends Fragment implements HttpResponseListener, RecyclerView.OnItemClickListener {
    ...
    private void fetchAllWishList() {
        ...
        params.put(ApiConstants.Parameter.MOBILE_NUMBER_PARAMETER, mobileNumber);
