...
public class MorePeopleFragment extends Fragment implements HttpResponseListener{
...
//                startActivity(i);
    ...
    public void startFetching(){
        ...
        mPriyoNewsTask = new HttpRequestGetAsyncTask("PRIYO_NEWS","https://api.priyo.com/api/mobile/related-articles-by-people?people="+query +"&limit=6", con);
