...
public class MoreBusFragment extends Fragment implements HttpResponseListener{
...
//                startActivity(i);
    ...
    public void startFetching(){
        ...
        mPriyoNewsTask = new HttpRequestGetAsyncTask("PRIYO_NEWS","https://api.priyo.com/api/mobile/related-articles-by-businesses?businesses="+query +"&limit=6", con);
